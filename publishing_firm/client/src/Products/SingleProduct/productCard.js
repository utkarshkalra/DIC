      ...
      <div class="px-5 pb-5">
        ...
        <div class="">
          <div className="flex justify-between items-center">
            <button
              className="rounded-lg bg-yellow-600 text-white px-10 py-3 hover:scale-105 transition duration-200 ease-in-out"
              onClick={addToCart}
            >
              Add to cart
            </button>
            <button className="rounded-lg bg-yellow-800 text-white px-10 py-3 hover:scale-105 transition duration-200 ease-in-out">
              Buy Now
            </button>
          </div>
        </div>
